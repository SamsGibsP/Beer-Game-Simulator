...
## 👥 Alur Permainan
1. **Host** membuka aplikasi, menekan **"Create New Room"**, dan membagikan *Room Code*.
2. **4 Mahasiswa/Tim** bergabung menggunakan *Room Code* dan memilih peran: Retailer, Wholesaler, Distributor, atau Factory.
...
5. Permainan selesai dan pemain diarahkan semua orang ke Dasbor Analitik Akhir.
